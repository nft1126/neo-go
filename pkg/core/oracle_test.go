...
func TestOracle(t *testing.T) {
	...
	putOracleRequest(t, cs.Hash, bc, "http://get.1234", new(string), "handle", []byte{}, 10_000_000)
	putOracleRequest(t, cs.Hash, bc, "http://get.timeout", new(string), "handle", []byte{}, 10_000_000)
	putOracleRequest(t, cs.Hash, bc, "http://get.notfound", new(string), "handle", []byte{}, 10_000_000)
	putOracleRequest(t, cs.Hash, bc, "http://get.forbidden", new(string), "handle", []byte{}, 10_000_000)
	putOracleRequest(t, cs.Hash, bc, "http://get.big", new(string), "handle", []byte{}, 10_000_000)
	putOracleRequest(t, cs.Hash, bc, "http://get.maxallowed", new(string), "handle", []byte{}, 10_000_000)
	putOracleRequest(t, cs.Hash, bc, "http://get.maxallowed", new(string), "handle", []byte{}, 100_000_000)
