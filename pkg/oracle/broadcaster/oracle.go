...
func New(cfg config.OracleConfiguration, log *zap.Logger) interfaces.Broadcaster {
...
// Run implements interfaces.Broadcaster.
...
// Shutdown implements interfaces.Broadcaster.
